...
public class PlanController {
    ...
    @RequestMapping(value = "/plan/delete/{planId}", method = {RequestMethod.GET, RequestMethod.POST})
    public Object deletePlan(@PathVariable int planId, HttpSession session) {
        return planService.deletePlan(planId, session);
    }

    @RequestMapping(value = "/plan/get/list", method = {RequestMethod.POST})
    public Object getPlanList(@RequestBody GetPlansReq req, HttpSession session) {
        return planService.getPlans(req, session);
    }

    @RequestMapping(value = "/plan/get/details/{planId}", method = {RequestMethod.GET, RequestMethod.POST})
